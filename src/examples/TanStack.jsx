...
import TanStackGrid from "../grids/TanStack.jsx";
...
class TanStackExample extends Component {
  constructor(props) {
    super(props);
    ...
    return (
      <ExampleContainer>
        <InfoPanel>
          ...
          <p>
            Implementazione di TanStack Table usando la configurazione gridSetup
            di Fattura24. Supporta colonne bloccate, ordinamento, selezione e
            custom renderers.
          </p>
